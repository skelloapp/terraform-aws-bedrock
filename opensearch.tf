      ...
      Rules = [
        {
          ResourceType = "index"
          Resource = [
            "index/${module.oss-knowledgebase[0].opensearch_serverless_collection.name}/*"
          ]
          Permission = [
            "aoss:UpdateIndex",
            "aoss:DeleteIndex",
        ...
        },
        {
          ...
          Resource = [
            "collection/${module.oss-knowledgebase[0].opensearch_serverless_collection.name}"
          ]
          Permission = [
...
resource "time_sleep" "wait_after_index_creation" {
  count           = var.create_default_kb ? 1 : 0
  depends_on      = [ module.oss-knowledgebase[0].vector_index ]
